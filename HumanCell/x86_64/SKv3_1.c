...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 SKv3_1 /Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/x86_64/SKv3_1.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    mInf = 1.0 / ( 1.0 + exp ( ( ( v - ( 18.700 - shift ) ) / ( - 9.700 ) ) ) ) ;
   mTau = 0.2 * 20.000 / ( 1.0 + exp ( ( ( v - ( - 46.560 - shift ) ) / ( - 44.140 ) ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/SKv3_1.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"
  ...
  "PROCEDURE rates(){\n"
  "	UNITSOFF\n"
  "		mInf =  1/(1+exp(((v -(18.700-shift))/(-9.700))))\n"
  "		mTau =  0.2*20.000/(1+exp(((v -(-46.560-shift))/(-44.140))))\n"
  "	UNITSON\n"
  "}\n"
  ;
#endif
