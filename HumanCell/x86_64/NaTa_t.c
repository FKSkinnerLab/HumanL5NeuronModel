...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaTa_t /Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/x86_64/NaTa_t.mod\n");
...
static int  rates ( _threadargsproto_ ) {
 ...
 _lqt = pow( 2.3 , ( ( 34.0 - 21.0 ) / 10.0 ) ) ;
   ...
   hAlpha = ( - 0.015 * ( v - ( - 66.0 - shift ) ) ) / ( 1.0 - ( exp ( ( v - ( - 66.0 - shift ) ) / 6.0 ) ) ) ;
   hBeta = ( - 0.015 * ( - v + ( - 66.0 - shift ) ) ) / ( 1.0 - ( exp ( ( - v + ( - 66.0 - shift ) ) / 6.0 ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/NaTa_t.mod";
static const char* nmodl_file_text = 
