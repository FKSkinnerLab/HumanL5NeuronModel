...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nap_Et2 /Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/x86_64/Nap_Et2.mod\n");
...
static int  rates ( _threadargsproto_ ) {
 ...
 _lqt = pow( 2.3 , ( ( 34.0 - 21.0 ) / 10.0 ) ) ;
    mInf = 1.0 / ( 1.0 + exp ( ( v - ( - 52.6 - shift ) ) / - 4.6 ) ) ;
   if ( v  == - 38.0 - shift ) {
     v = v + 0.0001 ;
     }
   mAlpha = ( 0.182 * ( v - ( - 38.0 - shift ) ) ) / ( 1.0 - ( exp ( - ( v - ( - 38.0 - shift ) ) / 6.0 ) ) ) ;
   mBeta = ( 0.124 * ( - v + ( - 38.0 - shift ) ) ) / ( 1.0 - ( exp ( - ( - v + ( - 38.0 - shift ) ) / 6.0 ) ) ) ;
   ...
   hInf = 1.0 / ( 1.0 + exp ( ( v - ( - 48.8 - shift ) ) / 10.0 ) ) ;
   hAlpha = - 2.88e-6 * ( v + ( 17.0 - shift ) ) / ( 1.0 - exp ( ( v + ( 17.0 - shift ) ) / 4.63 ) ) ;
   hBeta = 6.94e-6 * ( v + ( 64.4 - shift ) ) / ( 1.0 - exp ( - ( v + ( 64.4 - shift ) ) / 2.63 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/scottrich/OneDrive - UHN/3) NEURON stuff/HumanCellOrganized_v2/Nap_Et2.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  "	UNITSOFF\n"
  "		mInf = 1.0/(1+exp((v- (-52.6 - shift))/-4.6))\n"
  "    if(v == -38 - shift){\n"
  "    	v = v+0.0001\n"
  "    }\n"
  ...
  "    }\n"
  "\n"
  "		hInf = 1.0/(1+exp((v- (-48.8 - shift))/10))\n"
  "    hAlpha = -2.88e-6 * (v + (17 - shift)) / (1 - exp((v + (17 - shift))/4.63))\n"
  "    hBeta = 6.94e-6 * (v + (64.4 - shift)) / (1 - exp(-(v + (64.4 - shift))/2.63))\n"
